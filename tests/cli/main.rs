...
macro_rules! test_inspect_subcommand {
...
#[test]
fn inspect_with_all_options() -> Result<(), Box<dyn std::error::Error>> {
    let tempfile = utils::jma_tornado_nowcast_file()?;
    let arg_path = tempfile.path();
...
macro_rules! test_decode_subcommand_with_no_options {
...
test_decode_subcommand_with_no_options! {
    (
        decode_simple_packing,
    ...
    (
        decode_run_length_encoding,
        utils::jma_tornado_nowcast_file()?,
        "0.3"
    ),
}

macro_rules! test_decode_subcommand_with_data_without_nan_values_and_byte_order_options {
...
test_decode_subcommand_with_data_without_nan_values_and_byte_order_options! {
    (
        decode_simple_packing_as_big_endian,
        utils::jma_kousa_file()?,
        "0.3",
        "-b",
    ...
    (
        decode_simple_packing_as_little_endian,
        utils::jma_kousa_file()?,
        "0.3",
        "-l",
    ...
    (
        decode_complex_packing_as_little_endian,
        utils::jma_meps_file()?,
        "0.2",
        "-l",
...
macro_rules! test_decode_subcommand_with_data_with_nan_values_as_little_endian {
    ($(($name:ident, $input:expr, $message_index:expr, $byte_order_flag:expr, $expected:expr),)*) => ($(
        #[test]
        fn $name() -> Result<(), Box<dyn std::error::Error>> {
            let input = $input;
...
test_decode_subcommand_with_data_with_nan_values_as_little_endian! {
    (
        decode_run_length_packing_as_little_endian,
        utils::jma_tornado_nowcast_file()?,
        "0.3",
        "-l",
    ...
    (
        decode_simple_packing_with_bitmap_as_little_endian,
        utils::jma_msmguid_file()?,
        "0.0",
        "-l",
