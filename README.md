...
| 5.40 | JPEG 2000 code stream format | enabling feature `jpeg2000-support-openjpeg` required |
| 5.41 | Portable Network Graphics (PNG) | enabling feature `png-support-png-crate` required |
| 5.42 | CCSDS recommended lossless compression | enabling feature `ccsds-support-libaec` required |
