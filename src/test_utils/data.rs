...
pub(crate) mod grib2 {
    ...
    definitions_of_grib2_test_data! {
        (cmc_glb, "CMC_glb_TMP_ISBL_1_latlon.24x.24_2021051800_P000.grib2"),
        (ecmwf_realtime_oper_fc_0, "20240101000000-0h-oper-fc.grib2.0-10.xz"),
        (ecmwf_realtime_oper_fc_89, "20250912120000-0h-oper-fc.grib2.89.xz"),
        (
            jma_kousa,
        ...
        (noaa_mrms_merged_rho_hv, "MRMS_MergedRhoHV_19.00_20260219-042039.grib2.gz"),
        (noaa_mrms_precip_flag, "MRMS_PrecipFlag_00.00_20260219-042400.grib2.gz"),
        (noaa_mrms_reflectivity, "MRMS_ReflectivityAtLowestAltitude_00.50_20230406-120039.grib2.gz"),
...
pub(crate) mod flat_binary {
    ...
    definitions_of_flat_binary_test_data! {
        ...
        (ecmwf_realtime_oper_fc_89_le, "ecmwf-realtime-oper-fc-89-le.bin.xz"),
        ...
        (noaa_mrms_merged_rho_hv_le, "mrms-merged-rho-hv-wgrib2-le.bin.xz"),
        (noaa_mrms_precip_flag_le, "mrms-precip-flag-wgrib2-le.bin.xz"),
        (noaa_mrms_reflectivity_le, "mrms-reflectivity-wgrib2-le.bin.xz"),
