...
use crate::{
    def::grib2::template::param_set::{LatLonGrid, ScanningMode},
    error::GribError,
};
...
impl LatLonGrid {
    ...
    ///
    /// ```
    /// let def = grib::def::grib2::template::param_set::LatLonGrid {
...
mod tests {
    use super::*;
    use crate::def::grib2::template::param_set::{Grid, ResolutionAndComponentFlags};
